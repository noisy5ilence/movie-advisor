...
export const OPENPANEL_CLIENT_ID = process.env.NEXT_PUBLIC_OPENPANEL_CLIENT_ID;
export const OPENPANEL_API_URL = process.env.NEXT_PUBLIC_OPENPANEL_API_URL;
export const OPENPANEL_SCRIPT_URL = process.env.NEXT_PUBLIC_OPENPANEL_SCRIPT_URL;
